...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getCharset(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getDebugLogFilePath(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getDirPrefix(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getGroupName(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getLastErrorHtml(HCkTarW cHandle);
CK_VISIBLE_PUBLIC void CkTarW_getLastErrorText(HCkTarW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getLastErrorText(HCkTarW cHandle);
CK_VISIBLE_PUBLIC void CkTarW_getLastErrorXml(HCkTarW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getLastErrorXml(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getMustMatch(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getMustNotMatch(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getUntarFromDir(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getUntarMatchPattern(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getUserName(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getVersion(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getWriteFormat(HCkTarW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTarW_getXmlListing(HCkTarW cHandle);
