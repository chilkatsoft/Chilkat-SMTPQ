...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getBody(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getBounceAddress(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getCharset(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getDebugLogFilePath(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getEmailDateStr(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getEncryptedBy(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getEncryptedBy(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getFileDistList(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getFrom(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getFromAddress(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getFromName(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getHeader(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getHeader(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getLanguage(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getLanguage(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getLastErrorHtml(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getLastErrorHtml(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getLastErrorText(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getLastErrorText(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getLastErrorXml(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getLastErrorXml(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getLocalDateStr(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getMailer(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getOaepHash(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getOaepMgfHash(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getPkcs7CryptAlg(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getPreferredCharset(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getReplyTo(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getSender(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getSignedBy(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getSigningAlg(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getSigningHashAlg(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getSubject(HCkEmailW cHandle);
CK_VISIBLE_PUBLIC void CkEmailW_getUidl(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getUidl(HCkEmailW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_getVersion(HCkEmailW cHandle);
