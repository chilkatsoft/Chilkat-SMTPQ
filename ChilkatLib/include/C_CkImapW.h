...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getAuthMethod(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getAuthzId(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getClientIpAddress(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getConnectedToHost(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getConnectedToHost(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getDebugLogFilePath(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getDomain(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getHttpProxyAuthMethod(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getHttpProxyDomain(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getHttpProxyHostname(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getHttpProxyPassword(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getHttpProxyUsername(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastAppendedMime(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastCommand(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastCommand(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastErrorHtml(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastErrorHtml(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastErrorText(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastErrorText(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastErrorXml(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastErrorXml(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastIntermediateResponse(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastIntermediateResponse(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastResponse(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLastResponseCode(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLastResponseCode(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getLoggedInUser(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getLoggedInUser(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSearchCharset(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getSelectedMailbox(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSelectedMailbox(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSeparatorChar(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getSessionLog(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSessionLog(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSocksHostname(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSocksPassword(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSocksUsername(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSslAllowedCiphers(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getSslProtocol(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getTlsCipherSuite(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getTlsPinSet(HCkImapW cHandle);
CK_VISIBLE_PUBLIC void CkImapW_getTlsVersion(HCkImapW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getTlsVersion(HCkImapW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkImapW_getVersion(HCkImapW cHandle);
