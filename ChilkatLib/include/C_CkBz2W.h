...
CK_VISIBLE_PUBLIC const wchar_t *CkBz2W_getDebugLogFilePath(HCkBz2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkBz2W_getLastErrorHtml(HCkBz2W cHandle);
CK_VISIBLE_PUBLIC void CkBz2W_getLastErrorText(HCkBz2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkBz2W_getLastErrorText(HCkBz2W cHandle);
CK_VISIBLE_PUBLIC void CkBz2W_getLastErrorXml(HCkBz2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkBz2W_getLastErrorXml(HCkBz2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkBz2W_getVersion(HCkBz2W cHandle);
