...
CK_VISIBLE_PUBLIC int CkXmlDSigGen_getSigLocationMod(HCkXmlDSigGen cHandle);
CK_VISIBLE_PUBLIC void CkXmlDSigGen_putSigLocationMod(HCkXmlDSigGen cHandle, int newVal);
