...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getAltToCharset(HCkCharsetW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getDebugLogFilePath(HCkCharsetW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getFromCharset(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastErrorHtml(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastErrorHtml(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastErrorText(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastErrorText(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastErrorXml(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastErrorXml(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastInputAsHex(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastInputAsHex(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastInputAsQP(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastInputAsQP(HCkCharsetW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastOutputAsHex(HCkCharsetW cHandle);
CK_VISIBLE_PUBLIC void CkCharsetW_getLastOutputAsQP(HCkCharsetW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getLastOutputAsQP(HCkCharsetW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getToCharset(HCkCharsetW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCharsetW_getVersion(HCkCharsetW cHandle);
