...
CK_VISIBLE_PUBLIC BOOL CkCsp_GetProviders(HCkCsp cHandle, HCkStringTable providerNames);
...
CK_VISIBLE_PUBLIC BOOL CkCsp_LoadSmartcardCert(HCkCsp cHandle, HCkCert cert);
