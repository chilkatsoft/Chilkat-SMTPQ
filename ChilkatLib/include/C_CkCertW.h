...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getAuthorityKeyId(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getCspName(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getDebugLogFilePath(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getOcspUrl(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getRfc822Name(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSerialNumber(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSha1Thumbprint(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSha1Thumbprint(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectC(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectCN(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectCN(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectDN(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectDN(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectE(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectE(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectKeyId(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectKeyId(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectL(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectL(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectO(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectO(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectOU(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectOU(HCkCertW cHandle);
CK_VISIBLE_PUBLIC void CkCertW_getSubjectS(HCkCertW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getSubjectS(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getValidFromStr(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getValidToStr(HCkCertW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertW_getVersion(HCkCertW cHandle);
