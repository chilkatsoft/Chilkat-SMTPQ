...
CK_VISIBLE_PUBLIC const wchar_t *CkServerSentEventW_getData(HCkServerSentEventW cHandle);
CK_VISIBLE_PUBLIC void CkServerSentEventW_getEventName(HCkServerSentEventW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkServerSentEventW_getEventName(HCkServerSentEventW cHandle);
CK_VISIBLE_PUBLIC void CkServerSentEventW_getLastEventId(HCkServerSentEventW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkServerSentEventW_getLastEventId(HCkServerSentEventW cHandle);
