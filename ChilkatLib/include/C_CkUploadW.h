...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getClientIpAddress(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getDebugLogFilePath(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getHostname(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getLastErrorHtml(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void CkUploadW_getLastErrorText(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getLastErrorText(HCkUploadW cHandle);
CK_VISIBLE_PUBLIC void CkUploadW_getLastErrorXml(HCkUploadW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getLastErrorXml(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getLogin(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getPassword(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getPath(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getProxyDomain(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getProxyLogin(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getProxyPassword(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getResponseHeader(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getSslAllowedCiphers(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getSslProtocol(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getTlsPinSet(HCkUploadW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkUploadW_getVersion(HCkUploadW cHandle);
