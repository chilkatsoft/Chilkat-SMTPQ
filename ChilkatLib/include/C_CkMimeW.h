...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getBoundary(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getCharset(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getContentType(HCkMimeW cHandle);
CK_VISIBLE_PUBLIC void CkMimeW_getCurrentDateTime(HCkMimeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getCurrentDateTime(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getDebugLogFilePath(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getDisposition(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getEncoding(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getFilename(HCkMimeW cHandle);
CK_VISIBLE_PUBLIC void CkMimeW_getLastErrorHtml(HCkMimeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getLastErrorHtml(HCkMimeW cHandle);
CK_VISIBLE_PUBLIC void CkMimeW_getLastErrorText(HCkMimeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getLastErrorText(HCkMimeW cHandle);
CK_VISIBLE_PUBLIC void CkMimeW_getLastErrorXml(HCkMimeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getLastErrorXml(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getMicalg(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getName(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getOaepHash(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getOaepMgfHash(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getPkcs7CryptAlg(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getProtocol(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getSigningAlg(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getSigningHashAlg(HCkMimeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkMimeW_getVersion(HCkMimeW cHandle);
