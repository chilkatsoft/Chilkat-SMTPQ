...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getClientIdentifier(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getClientIpAddress(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getDebugLogFilePath(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getDisconnectReason(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getFilenameCharset(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getForceCipher(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHostKeyAlg(HCkSFtpW cHandle);
CK_VISIBLE_PUBLIC void CkSFtpW_getHostKeyFingerprint(HCkSFtpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHostKeyFingerprint(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHttpProxyAuthMethod(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHttpProxyDomain(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHttpProxyHostname(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHttpProxyPassword(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getHttpProxyUsername(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getInitializeFailReason(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getLastErrorHtml(HCkSFtpW cHandle);
CK_VISIBLE_PUBLIC void CkSFtpW_getLastErrorText(HCkSFtpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getLastErrorText(HCkSFtpW cHandle);
CK_VISIBLE_PUBLIC void CkSFtpW_getLastErrorXml(HCkSFtpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getLastErrorXml(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getReadDirMustMatch(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getReadDirMustNotMatch(HCkSFtpW cHandle);
CK_VISIBLE_PUBLIC void CkSFtpW_getServerIdentifier(HCkSFtpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getServerIdentifier(HCkSFtpW cHandle);
CK_VISIBLE_PUBLIC void CkSFtpW_getSessionLog(HCkSFtpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSessionLog(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSocksHostname(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSocksPassword(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSocksUsername(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSyncDirectives(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSyncedFiles(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSyncMustMatch(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getSyncMustNotMatch(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getUncommonOptions(HCkSFtpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSFtpW_getVersion(HCkSFtpW cHandle);
