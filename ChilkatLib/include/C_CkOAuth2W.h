...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getAccessToken(HCkOAuth2W cHandle);
CK_VISIBLE_PUBLIC void CkOAuth2W_getAccessTokenResponse(HCkOAuth2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getAccessTokenResponse(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getAppCallbackUrl(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getAuthorizationEndpoint(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getClientId(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getClientSecret(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getCodeChallengeMethod(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getDebugLogFilePath(HCkOAuth2W cHandle);
CK_VISIBLE_PUBLIC void CkOAuth2W_getFailureInfo(HCkOAuth2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getFailureInfo(HCkOAuth2W cHandle);
CK_VISIBLE_PUBLIC void CkOAuth2W_getLastErrorHtml(HCkOAuth2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getLastErrorHtml(HCkOAuth2W cHandle);
CK_VISIBLE_PUBLIC void CkOAuth2W_getLastErrorText(HCkOAuth2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getLastErrorText(HCkOAuth2W cHandle);
CK_VISIBLE_PUBLIC void CkOAuth2W_getLastErrorXml(HCkOAuth2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getLastErrorXml(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getLocalHost(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getRedirectAllowHtml(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getRedirectDenyHtml(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getRefreshToken(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getResource(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getScope(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getTokenEndpoint(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getTokenType(HCkOAuth2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkOAuth2W_getVersion(HCkOAuth2W cHandle);
