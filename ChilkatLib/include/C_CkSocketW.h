...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncAcceptLog(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncConnectLog(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncDnsLog(HCkSocketW cHandle);
CK_VISIBLE_PUBLIC void CkSocketW_getAsyncDnsResult(HCkSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncDnsResult(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncReceivedString(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncReceiveLog(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getAsyncSendLog(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getClientIpAddress(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getDebugLogFilePath(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getHttpProxyAuthMethod(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getHttpProxyDomain(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getHttpProxyHostname(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getHttpProxyPassword(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getHttpProxyUsername(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getLastErrorHtml(HCkSocketW cHandle);
CK_VISIBLE_PUBLIC void CkSocketW_getLastErrorText(HCkSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getLastErrorText(HCkSocketW cHandle);
CK_VISIBLE_PUBLIC void CkSocketW_getLastErrorXml(HCkSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getLastErrorXml(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getLocalIpAddress(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getMyIpAddress(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getRemoteIpAddress(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSessionLog(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSessionLogEncoding(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSocksHostname(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSocksPassword(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSocksUsername(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSslAllowedCiphers(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getSslProtocol(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getStringCharset(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getTlsCipherSuite(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getTlsPinSet(HCkSocketW cHandle);
CK_VISIBLE_PUBLIC void CkSocketW_getTlsVersion(HCkSocketW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getTlsVersion(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getUserData(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSocketW_getVersion(HCkSocketW cHandle);
