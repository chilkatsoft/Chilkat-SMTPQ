...
CK_VISIBLE_PUBLIC int CkSocketW_getRcvBytesPerSec(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC int CkSocketW_getSendBytesPerSec(HCkSocketW cHandle);
...
CK_VISIBLE_PUBLIC void CkSocketW_ResetPerf(HCkSocketW cHandle, BOOL rcvPerf);
