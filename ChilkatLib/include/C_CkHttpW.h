...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAccept(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAcceptCharset(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAcceptLanguage(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAuthToken(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAwsAccessKey(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAwsEndpoint(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAwsRegion(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAwsSecretKey(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getAwsSubResources(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getBgLastErrorText(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getBgResultString(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getClientIpAddress(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getConnection(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getCookieDir(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getDebugLogFilePath(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getFinalRedirectUrl(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastContentType(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastErrorHtml(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastErrorHtml(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastErrorText(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastErrorText(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastErrorXml(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastErrorXml(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastHeader(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastHeader(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastModDate(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastResponseBody(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastResponseBody(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getLastResponseHeader(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastResponseHeader(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLastStatusText(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLogin(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getLoginDomain(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthCallback(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthConsumerKey(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthConsumerSecret(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthRealm(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthSigMethod(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthToken(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthTokenSecret(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getOAuthVerifier(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getPassword(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getProxyAuthMethod(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getProxyDomain(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getProxyLogin(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getProxyLoginDomain(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getProxyPassword(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getRedirectVerb(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getReferer(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getRequiredContentType(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSessionLogFilename(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSocksHostname(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSocksPassword(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSocksUsername(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSslAllowedCiphers(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getSslProtocol(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getStreamResponseBodyPath(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getTlsCipherSuite(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getTlsCipherSuite(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getTlsPinSet(HCkHttpW cHandle);
CK_VISIBLE_PUBLIC void CkHttpW_getTlsVersion(HCkHttpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getTlsVersion(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getUserAgent(HCkHttpW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkHttpW_getVersion(HCkHttpW cHandle);
