...
CK_VISIBLE_PUBLIC const wchar_t *CkTrustedRootsW_getDebugLogFilePath(HCkTrustedRootsW cHandle);
CK_VISIBLE_PUBLIC void CkTrustedRootsW_getLastErrorHtml(HCkTrustedRootsW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkTrustedRootsW_getLastErrorHtml(HCkTrustedRootsW cHandle);
CK_VISIBLE_PUBLIC void CkTrustedRootsW_getLastErrorText(HCkTrustedRootsW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkTrustedRootsW_getLastErrorText(HCkTrustedRootsW cHandle);
CK_VISIBLE_PUBLIC void CkTrustedRootsW_getLastErrorXml(HCkTrustedRootsW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkTrustedRootsW_getLastErrorXml(HCkTrustedRootsW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkTrustedRootsW_getVersion(HCkTrustedRootsW cHandle);
