...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailBundleW_getDebugLogFilePath(HCkEmailBundleW cHandle);
CK_VISIBLE_PUBLIC void CkEmailBundleW_getLastErrorHtml(HCkEmailBundleW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailBundleW_getLastErrorHtml(HCkEmailBundleW cHandle);
CK_VISIBLE_PUBLIC void CkEmailBundleW_getLastErrorText(HCkEmailBundleW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailBundleW_getLastErrorText(HCkEmailBundleW cHandle);
CK_VISIBLE_PUBLIC void CkEmailBundleW_getLastErrorXml(HCkEmailBundleW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailBundleW_getLastErrorXml(HCkEmailBundleW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEmailBundleW_getVersion(HCkEmailBundleW cHandle);
