...
CK_VISIBLE_PUBLIC const wchar_t *CkCertChainW_getDebugLogFilePath(HCkCertChainW cHandle);
CK_VISIBLE_PUBLIC void CkCertChainW_getLastErrorHtml(HCkCertChainW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertChainW_getLastErrorHtml(HCkCertChainW cHandle);
CK_VISIBLE_PUBLIC void CkCertChainW_getLastErrorText(HCkCertChainW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertChainW_getLastErrorText(HCkCertChainW cHandle);
CK_VISIBLE_PUBLIC void CkCertChainW_getLastErrorXml(HCkCertChainW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCertChainW_getLastErrorXml(HCkCertChainW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCertChainW_getVersion(HCkCertChainW cHandle);
