...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCadesSigPolicyHash(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCadesSigPolicyId(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCadesSigPolicyUri(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCharset(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCipherMode(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCompressionAlgorithm(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getCryptAlgorithm(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getDebugLogFilePath(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getEncodingMode(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getHashAlgorithm(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getLastErrorHtml(HCkCrypt2W cHandle);
CK_VISIBLE_PUBLIC void CkCrypt2W_getLastErrorText(HCkCrypt2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getLastErrorText(HCkCrypt2W cHandle);
CK_VISIBLE_PUBLIC void CkCrypt2W_getLastErrorXml(HCkCrypt2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getLastErrorXml(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getMacAlgorithm(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getOaepHash(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getOaepMgfHash(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getPbesAlgorithm(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getPbesPassword(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getPkcs7CryptAlg(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getSigningAlg(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getUuFilename(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getUuMode(HCkCrypt2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCrypt2W_getVersion(HCkCrypt2W cHandle);
