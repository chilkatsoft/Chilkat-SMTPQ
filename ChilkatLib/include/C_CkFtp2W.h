...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getAccount(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getAsyncBytesReceivedStr(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getAsyncBytesSentStr(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getAsyncLog(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getClientIpAddress(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getCommandCharset(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getDataProtection(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getDebugLogFilePath(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getDirListingCharset(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getForcePortIpAddress(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getGreeting(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getGreeting(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHostname(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHttpProxyAuthMethod(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHttpProxyDomain(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHttpProxyHostname(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHttpProxyPassword(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getHttpProxyUsername(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getLastErrorHtml(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getLastErrorText(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getLastErrorText(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getLastErrorXml(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getLastErrorXml(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getLastReply(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getListPattern(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getPassword(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getProxyHostname(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getProxyPassword(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getProxyUsername(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSessionLog(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSocksHostname(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSocksPassword(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSocksUsername(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSslAllowedCiphers(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSslProtocol(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSyncedFiles(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSyncMustMatch(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSyncMustNotMatch(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getSyncPreview(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getSyncPreview(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getTlsCipherSuite(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getTlsCipherSuite(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getTlsPinSet(HCkFtp2W cHandle);
CK_VISIBLE_PUBLIC void CkFtp2W_getTlsVersion(HCkFtp2W cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getTlsVersion(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getUsername(HCkFtp2W cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkFtp2W_getVersion(HCkFtp2W cHandle);
