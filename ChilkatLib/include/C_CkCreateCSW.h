...
CK_VISIBLE_PUBLIC const wchar_t *CkCreateCSW_getDebugLogFilePath(HCkCreateCSW cHandle);
CK_VISIBLE_PUBLIC void CkCreateCSW_getLastErrorHtml(HCkCreateCSW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCreateCSW_getLastErrorHtml(HCkCreateCSW cHandle);
CK_VISIBLE_PUBLIC void CkCreateCSW_getLastErrorText(HCkCreateCSW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCreateCSW_getLastErrorText(HCkCreateCSW cHandle);
CK_VISIBLE_PUBLIC void CkCreateCSW_getLastErrorXml(HCkCreateCSW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkCreateCSW_getLastErrorXml(HCkCreateCSW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkCreateCSW_getVersion(HCkCreateCSW cHandle);
