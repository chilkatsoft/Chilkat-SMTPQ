...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getBaseDir(HCkDirTreeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getDebugLogFilePath(HCkDirTreeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getFullPath(HCkDirTreeW cHandle);
CK_VISIBLE_PUBLIC void CkDirTreeW_getFullUncPath(HCkDirTreeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getFullUncPath(HCkDirTreeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getLastErrorHtml(HCkDirTreeW cHandle);
CK_VISIBLE_PUBLIC void CkDirTreeW_getLastErrorText(HCkDirTreeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getLastErrorText(HCkDirTreeW cHandle);
CK_VISIBLE_PUBLIC void CkDirTreeW_getLastErrorXml(HCkDirTreeW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getLastErrorXml(HCkDirTreeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getRelativePath(HCkDirTreeW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDirTreeW_getVersion(HCkDirTreeW cHandle);
