...
CK_VISIBLE_PUBLIC int CkFileAccessW_FileType(HCkFileAccessW cHandle, const wchar_t *path);
...
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_SymlinkCreate(HCkFileAccessW cHandle, const wchar_t *targetPath, const wchar_t *linkPath);
CK_VISIBLE_PUBLIC BOOL CkFileAccessW_SymlinkTarget(HCkFileAccessW cHandle, const wchar_t *linkPath, HCkString outStr);
CK_VISIBLE_PUBLIC const wchar_t *CkFileAccessW_symlinkTarget(HCkFileAccessW cHandle, const wchar_t *linkPath);
