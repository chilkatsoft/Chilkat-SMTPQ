...
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getDebugLogFilePath(HCkDhW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getLastErrorHtml(HCkDhW cHandle);
CK_VISIBLE_PUBLIC void CkDhW_getLastErrorText(HCkDhW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getLastErrorText(HCkDhW cHandle);
CK_VISIBLE_PUBLIC void CkDhW_getLastErrorXml(HCkDhW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getLastErrorXml(HCkDhW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getP(HCkDhW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDhW_getVersion(HCkDhW cHandle);
