...
CK_VISIBLE_PUBLIC const wchar_t *CkEccW_getDebugLogFilePath(HCkEccW cHandle);
CK_VISIBLE_PUBLIC void CkEccW_getLastErrorHtml(HCkEccW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEccW_getLastErrorHtml(HCkEccW cHandle);
CK_VISIBLE_PUBLIC void CkEccW_getLastErrorText(HCkEccW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEccW_getLastErrorText(HCkEccW cHandle);
CK_VISIBLE_PUBLIC void CkEccW_getLastErrorXml(HCkEccW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkEccW_getLastErrorXml(HCkEccW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkEccW_getVersion(HCkEccW cHandle);
