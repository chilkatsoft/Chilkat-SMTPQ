...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDebugLogFilePath(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDkimAlg(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDkimCanon(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDkimDomain(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDkimHeaders(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDkimSelector(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDomainKeyAlg(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDomainKeyCanon(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDomainKeyDomain(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDomainKeyHeaders(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getDomainKeySelector(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getLastErrorHtml(HCkDkimW cHandle);
CK_VISIBLE_PUBLIC void CkDkimW_getLastErrorText(HCkDkimW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getLastErrorText(HCkDkimW cHandle);
CK_VISIBLE_PUBLIC void CkDkimW_getLastErrorXml(HCkDkimW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getLastErrorXml(HCkDkimW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkDkimW_getVersion(HCkDkimW cHandle);
