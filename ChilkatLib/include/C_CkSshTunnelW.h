...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getAcceptLog(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getAcceptLogPath(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getDebugLogFilePath(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getDestHostname(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHostKeyFingerprint(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHttpProxyAuthMethod(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHttpProxyDomain(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHttpProxyHostname(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHttpProxyPassword(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getHttpProxyUsername(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getInboundSocksPassword(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getInboundSocksUsername(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getLastErrorHtml(HCkSshTunnelW cHandle);
CK_VISIBLE_PUBLIC void CkSshTunnelW_getLastErrorText(HCkSshTunnelW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getLastErrorText(HCkSshTunnelW cHandle);
CK_VISIBLE_PUBLIC void CkSshTunnelW_getLastErrorXml(HCkSshTunnelW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getLastErrorXml(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getListenBindIpAddress(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getOutboundBindIpAddress(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getSocksHostname(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getSocksPassword(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getSocksUsername(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getTunnelLog(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getTunnelLogPath(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getUncommonOptions(HCkSshTunnelW cHandle);
...
CK_VISIBLE_PUBLIC const wchar_t *CkSshTunnelW_getVersion(HCkSshTunnelW cHandle);
